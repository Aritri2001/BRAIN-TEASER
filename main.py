...
# Make connection
connection = create_server_connection("localhost", "root", "Sarada@123")
...
# database connection
def create_db_connection(localhost, root, passwd, database):
    connection = None
    try:
        connection = mysql.connector.connect(
            host = "localhost",
...
connection = create_db_connection("localhost", "root", "Sarada@123", "quiz")
...
# database connection
mydb=mysql.connector.connect(host="localhost", user="root", password="Sarada@123",database="quiz")
